...
import { Plus, Edit, Trash, Save, BookOpen } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-900 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl shadow-lg border border-gray-700/50 p-6 mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <input
              ...
              className="w-40 px-4 py-2 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              value={newTest.duration}
              onChange={(e) => setNewTest({ ...newTest, duration: parseInt(e.target.value) })}
            />
            <motion.button
              className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-lg flex items-center justify-center hover:from-blue-600 hover:to-purple-700 transition-all"
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl shadow-lg border border-gray-700/50 overflow-hidden">
          <div className="p-6">
            <h2 className="text-2xl font-semibold text-white mb-6">Manage Tests</h2>
          </div>
