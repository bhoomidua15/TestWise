        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl shadow-lg border border-gray-700/50 p-6 mb-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                className="w-full rounded-lg bg-gray-700/50 border border-gray-600 text-white placeholder-gray-400 p-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div>
              ...
              <select
                className="w-full rounded-lg bg-gray-700/50 border border-gray-600 text-white p-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <motion.button
              className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-3 rounded-lg flex items-center justify-center hover:from-blue-600 hover:to-purple-700 transition-all"
